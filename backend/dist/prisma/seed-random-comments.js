...
async function main() {
    ...
    console.log(`Done — added ${total} comments across ${recipes.length} recipe(s).`);
}
main()
    .catch((e) => {
    console.error(e);
...
//# sourceMappingURL=seed-random-comments.js.map